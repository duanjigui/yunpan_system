...
<body>
<form action="${pageContext.request.contextPath}/manager/rule/update" method="post">
		<div class="dataSerizeals">
			<table>
				...
				<tr>
					...
					<td><textarea rows="10" cols="70" name="rule_desc" >${rule.rule_desc}</textarea> </td>
				</tr>
				<tr>
					<td>规则特征符:</td>
					<td><input type="text" name='rule_sysmbol' value="${rule.rule_sysmbol}"/></td>
				</tr>
				<tr>
					<td>规则控制字段:</td>
					<td><input type="text" name="rule_control_field" value="${rule.rule_control_field}"/></td>
				</tr>
				<tr>
					<td style="vertical-align: baseline;">规则控制内容:</td>
					<td><textarea rows="10" cols="70" name="rule_control_content" >${rule.rule_control_content}</textarea> </td>
				</tr>
			</table>	
		</div>
