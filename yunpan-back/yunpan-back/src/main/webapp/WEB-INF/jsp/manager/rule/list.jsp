	...
	var dialog;
        ...
        function itemclick(item)
        {
            if(item.text == "修改"){
				...
				//向服务端发送要删除的数据
				var contents="<form action='${pageContext.request.contextPath}/manager/rule/delete' method='post'>";
        ...
        $(function ()
        {
            ...
            $("#maingrid").ligerGrid({
                ...
                pageSize :10,
                columns: [
                { display: '规则id', name: 'rule_id', align: 'center', width: 60, minWidth: 60 },
                { display: '规则名称', name: 'rule_name', minWidth: 50 },
                { display: '规则描述', name: 'rule_desc', minWidth: 50 },
                { display: '规则标识符', name: 'rule_sysmbol', minWidth: 50 },
                { display: '规则控制字段', name: 'rule_control_field', minWidth: 50 },
                { display: '规则控制内容', name: 'rule_control_content', minWidth: 50 },
