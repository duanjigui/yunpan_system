	...
	var dialog;
        ...
        function itemclick(item)
        {
            if(item.text == "修改"){
				...
				//向服务端发送要删除的数据
				var contents="<form action='${pageContext.request.contextPath}/manager/catelog/delete' method='post'>";
        ...
        $(function ()
        {
            ...
            $("#maingrid").ligerGrid({
                ...
                pageSize :10,
                columns: [
                { display: '内容id', name: 'catelog_id', align: 'center', width: 60, minWidth: 60 },
                { display: '所属栏目', name: 'catelog_type_name', minWidth: 50 },
                { display: '内容标题', name: 'title', minWidth: 50 },
                { display: '具体内容', name: 'content', minWidth: 50 },
