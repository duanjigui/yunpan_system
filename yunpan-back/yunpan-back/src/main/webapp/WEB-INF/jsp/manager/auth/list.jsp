	...
	var dialog;
        ...
        function itemclick(item)
        {
            if(item.text == "修改"){
				...
				//向服务端发送要删除的数据
				var contents="<form action='${pageContext.request.contextPath}/manager/auth/delete' method='post'>";
        ...
        $(function ()
        {
            ...
            $("#maingrid").ligerGrid({
                ...
                pageSize :10,
                columns: [
                { display: '权限id', name: 'auth_id', align: 'center', width: 60, minWidth: 60 },
                { display: '权限名称', name: 'auth_name', minWidth: 50 },
                { display: '权限描述', name: 'auth_desc', minWidth: 50 },
                { display: '权限标识符', name: 'auth_identity', minWidth: 50 },
                { display: '权限url', name: 'url', minWidth: 50 },
                { display: '排序', name: 'sort', minWidth: 50 },
                ...
                { display: '父权限名称', name: 'auth_p_name', minWidth: 50 }
