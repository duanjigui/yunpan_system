	...
	var dialog;
        ...
        $(function ()
        {
            ...
            $("#maingrid").ligerGrid({
                ...
                pageSize :10,
                columns: [
					{ display: '用户id', name: 'user_id', align: 'center',  width: 270, minWidth: 60 },
                ...
                toolbar: {
                    items: [
                    { text: '查看角色', click: itemclick, icon: 'view' },
                    { line: true },
                    { text: '赋予角色', click: itemclick, icon: 'modify' }
                    ]
                },
                autoFilter: true,
                checkbox :true,
