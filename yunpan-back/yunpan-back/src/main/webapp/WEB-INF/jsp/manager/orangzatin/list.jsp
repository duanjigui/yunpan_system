	...
	var dialog;
        ...
        function itemclick(item)
        {
            if(item.text == "修改"){
				...
				//向服务端发送要删除的数据
				var contents="<form action='${pageContext.request.contextPath}/manager/orianzation/delete' method='post'>";
        ...
        $(function ()
        {
            ...
            $("#maingrid").ligerGrid({
                ...
                pageSize :10,
                columns: [
                { display: '组织id', name: 'orange_id', align: 'center', width: 60, minWidth: 60 },
                { display: '组织名称', name: 'orange_name', minWidth: 50 },
                ...
                { display: '组织拥有者', name: 'organze_user_name', minWidth: 50 }
